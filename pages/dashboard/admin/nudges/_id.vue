        ...
        methods: {
            async create(){
                ...
                try {
                    ...
                    await this.$axios.$patch(`/nudges/${this.$route.params.id}`, this.form)
                    this.loading = false;

                    this.$toast.success("Nudge Updated successfully", {
                        icon : 'check'
                    });
            ...
            async getNudge(){
                let nudges = await this.$axios.$get(`/nudges/${this.$route.params.id}`)
                this.form = nudges.data.data;
                this.form.category = nudges.data.data.category.id
            },
