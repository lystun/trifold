                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" ref="podcast" required
...
<script>
    ...
    export default {
        ...
        head(){
            return {
                title: 'Create New Podcast | Trifold'
            }
        },
        ...
        methods: {
            ...
            async create(){
                ...
                try {
                    ...
                    await this.$axios.$post('/podcasts', formData)
