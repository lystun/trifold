                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" v-model="form.businessInfo" type="text" placeholder="Business Name" required>
                                </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" v-model="form.description" type="text" placeholder="Business Description" required>
                                </div>
                            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            async getMerchant(){
                let merchant = await this.$axios.$get(`/merchants/${this.$route.params.id}`);
                this.form = merchant.data.data
            },
            ...
            async create(){
                ...
                try {
                    ...
                    await this.$axios.$patch(`/merchants/${this.$route.params.id}`, formData);
                    this.loading = false;
