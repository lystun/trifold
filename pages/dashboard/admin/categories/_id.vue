...
<script>
    export default {
        ...
        methods: {
            ...
            async getCategory(){
                let categories = await this.$axios.$get(`/categories/${this.$route.params.id}`)
                this.form = categories.data.data;
            ...
            async create(){
                ...
                try {
                    ...
                    await this.$axios.$patch(`/categories/${this.$route.params.id}`, formData)
